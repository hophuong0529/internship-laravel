	...
	<div class="header_sub">
		<div class="h_menu">
			<ul>
				...
				<li><a href="sale.html">our shop</a></li> |
				<li><a href="handbags.html">our sale</a></li> |
				<li><a href="handbags.html">our service</a></li> |
				<li><a href="accessories.html">blog</a></li> |
				<li><a href="wallets.html">contact</a></li> |
				<li><a href="index.html">sign in</a></li> |
				<li><a href="shoes.html">sign up</a></li> |
			</ul>
		</div>
		<div class="top-nav">
	          <nav class="nav">	        	
	    	    <a href="#" id="w3-menu-trigger"> </a>
	                  <ul class="nav-list" style="">
							...
							<li class="nav-item"><a href="index.html">Sign In</a></li> 
							<li class="nav-item"><a href="shoes.html">Sign Up</a></li>
	                 </ul>
	           </nav>
	          ...
	          <div class="clear"> </div>
	          <script src="public/js/responsive.menu.js"></script>
         </div>		  
	<div class="clear"></div>
</div>
</div>
...
<!-- start slider -->
			<div id="da-slider" class="da-slider">
				<div class="da-slide">
					...
					<div class="da-img"><img src="public/images/slider1.png" alt="image01" /></div>
				</div>
				<div class="da-slide">
					<h2>Easy management</h2>
					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
					<a href="details.html" class="da-link">shop now</a>
					<div class="da-img"><img src="public/images/slider2.png" alt="image01" /></div>
				</div>
				<div class="da-slide">
					<h2>Revolution</h2>
					<p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
					<a href="details.html" class="da-link">shop now</a>
					<div class="da-img"><img src="public/images/slider3.png" alt="image01" /></div>
				</div>
				<div class="da-slide">
					<h2>Quality Control</h2>
					<p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar.</p>
					<a href="details.html" class="da-link">shop now</a>
					<div class="da-img"><img src="public/images/slider4.png" alt="image01" /></div>
				</div>
				<nav class="da-arrows">
...
<!----start-img-cursual---->
	<div id="owl-demo" class="owl-carousel">
		<div class="item" onclick="location.href='details.html';">
			<div class="cau_left">
				<img class="lazyOwl" data-src="public/images/c1.jpg" alt="Lazy Owl Image">
			</div>
			<div class="cau_left">
		...
		<div class="item" onclick="location.href='details.html';">
			<div class="cau_left">
				<img class="lazyOwl" data-src="public/images/c2.jpg" alt="Lazy Owl Image">
			</div>
			<div class="cau_left">
		...
		<div class="item" onclick="location.href='details.html';">
			<div class="cau_left">
				<img class="lazyOwl" data-src="public/images/c3.jpg" alt="Lazy Owl Image">
			</div>
			<div class="cau_left">
