...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            <div class="login100-form-title" style="background-image: url({{ asset('public/images/bg-01.jpg') }});">
            ...
            <form method="post" class="login100-form validate-form">
                ...
                <div class="container-login100-form-btn">
                    <button class="login100-form-btn" style="margin-bottom: 10%;" type="submit">
                        Login
                    </button>
                </div>
                @if ($errors->any())
...
<script src="{{ asset('public/s/main.js') }}"></script>
