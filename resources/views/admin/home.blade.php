...
@section('content')
    <div class="row">
        <div class="col-lg-9 main-chart">
            <h1 style="margin-left: 40%; margin-top: 20px;">Dashbroad</h1>
            <!--CUSTOM CHART START -->
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb">
                    <div class="weather pn"
                         style="background: url('public/images/weather.jpg') no-repeat center top;">
                    ...
                    <div class="message-p pn">
                        ...
                        <div class="row">
                            <div class="col-md-3 centered hidden-sm hidden-xs">
                                <img src="{{ asset('public/images/ui-danro.jpg') }}" class="img-circle" width="65"
                                     alt="">
                            </div>
                            <div class="col-md-9">
                                <p>
                                ...
                                <form class="form-inline" role="form">
                                    <div class="form-group">
                                        <label for="exampleInputText"></label><input type="text"
                                                                                     class="form-control"
                                                                                     id="exampleInputText"
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb">
                    ...
                    <div class="white-panel pn">
                        ...
                        <p><img src="{{ asset('public/images/ui-zac.jpg') }}" class="img-circle" width="50" alt="">
                        </p>
                        <p><b>Zac Snider</b></p>
                        <div class="row">
                            <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 mb">
                    <div class="product-panel-2 pn">
                        ...
                        <img src="{{ asset('public/images/product.jpg') }}" width="200" alt="">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 mb">
                    <div class="content-panel pn">
                        <div id="profile-02">
                            <div class="user">
                                <img src="{{ asset('public/images/friends/fr-06.jpg') }}" class="img-circle"
                                     width="80"
                                     alt="">
                                <h4>DJ SHERMAN</h4>
                            </div>
